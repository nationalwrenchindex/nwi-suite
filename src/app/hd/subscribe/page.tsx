...
export default function HDSubscribePage() {
  ...
  return (
    <div style={{ minHeight: '100dvh', background: 'var(--hd-bg)', color: 'var(--hd-text)', padding: '2rem 1.25rem' }}>
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <p style={{ fontSize: 14, color: 'rgba(var(--hd-ink-rgb), 0.45)', margin: 0 }}>
              ...
              >
                ...
                <div style={{ position: 'absolute', top: '1rem', right: '1rem' }}>
                  <div style={{
                    ...
                    height:      18,
                    borderRadius: '50%',
                    border:      `2px solid ${isSelected ? HD_ORANGE : 'var(--hd-border)'}`,
                    background:  isSelected ? HD_ORANGE : 'transparent',
                    display:     'flex',
                    alignItems:  'center',
                    justifyContent: 'center',
                  }}>
                    {isSelected && <span style={{ color: 'var(--hd-text)', fontSize: 10, fontWeight: 900 }}>✓</span>}
                  </div>
                </div>
                ...
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
                  {features.map(f => (
                    <li key={f} style={{ display: 'flex', alignItems: 'center', gap: 7, fontSize: 12, color: 'rgba(var(--hd-ink-rgb), 0.6)' }}>
        ...
        {/* Promo code */}
        <div style={{ background: 'var(--hd-card)', border: '1px solid var(--hd-border)', borderRadius: 12, padding: '1.125rem 1.25rem', marginBottom: '1.25rem' }}>
          <p style={{ fontSize: 12, color: 'rgba(var(--hd-ink-rgb), 0.4)', margin: '0 0 0.625rem', fontWeight: 500 }}>
            Promo Code (optional)
          </p>
          <div style={{ display: 'flex', gap: '0.625rem' }}>
            <input
              ...
              style={{
                ...
                border:      `1px solid ${promoStatus === 'valid' ? '#22C55E' : promoStatus === 'invalid' ? '#EF4444' : 'var(--hd-border)'}`,
                borderRadius: 8,
        ...
        <p style={{ fontSize: 11, color: 'rgba(var(--hd-ink-rgb), 0.25)', textAlign: 'center', marginTop: '1rem' }}>
